...
function px_ends_with($string, $test) {
...
function px_replace_last_occurrence($haystack, $needle, $replacement) {
...
function px_remove_last_occurrence($haystack, $needle)
{
    return px_remove_last_occurrence($haystack, $needle, '');
}

//Simple path combining function
function px_path_combine($path1, $path2)
{
    ...
    return call_user_func_array('px_path_combine', $newArgs);
}